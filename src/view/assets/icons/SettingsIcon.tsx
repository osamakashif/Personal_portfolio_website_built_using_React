export const SettingsIcon = ({
  className = "icon-stroke icon-transparent-background-fill",
}: {
  className?: string;
}) => {
  return (
    // Original SVG Source: https://www.svgrepo.com/svg/454020/settings
    // Original SVG Authour: H2D2 Design.
    // Original SVG License: MIT License.
    // Original License link: https://www.svgrepo.com/page/licensing/#MIT
